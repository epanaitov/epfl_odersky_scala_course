...
object week4 {import scala.runtime.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(77); 
  ...
  def nth[T](index: Integer, list: List[T]): T = {
	...
	One2 - One;System.out.println("""res5: week4.Nat = """ + $show(res$5));$skip(96); 
	
	val a: Array[NonEmpty] = Array(new NonEmpty(new Tweet("", "", 0), new Empty(), new Empty()));System.out.println("""a  : Array[objsets.NonEmpty] = """ + $show(a ))}
